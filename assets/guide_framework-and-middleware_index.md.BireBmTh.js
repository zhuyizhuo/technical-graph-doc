import{_ as a,c as i,o as n,ag as l}from"./chunks/framework.CyMCuEUM.js";const d=JSON.parse('{"title":"框架与中间件","description":"","frontmatter":{},"headers":[],"relativePath":"guide/framework-and-middleware/index.md","filePath":"guide/framework-and-middleware/index.md"}'),e={name:"guide/framework-and-middleware/index.md"};function t(h,s,p,r,E,k){return n(),i("div",null,[...s[0]||(s[0]=[l(`<h1 id="框架与中间件" tabindex="-1">框架与中间件 <a class="header-anchor" href="#框架与中间件" aria-label="Permalink to &quot;框架与中间件&quot;">​</a></h1><p>框架与中间件是现代Java应用开发的重要基础设施，它们提供了丰富的功能组件和最佳实践，极大地提高了开发效率和系统质量。本模块将介绍Java生态系统中常用的框架与中间件，帮助您选择合适的技术栈构建高质量的应用系统。</p><h2 id="模块知识体系" tabindex="-1">模块知识体系 <a class="header-anchor" href="#模块知识体系" aria-label="Permalink to &quot;模块知识体系&quot;">​</a></h2><div class="language-markdown vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">markdown</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">├── 🌸 Spring 生态系统</span></span>
